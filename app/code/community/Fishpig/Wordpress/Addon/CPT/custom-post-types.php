<?php
/*
Plugin Name: FishPig's Custom Post Types
Plugin URI:  http://fishpig.co.uk/magento/wordpress-integration/custom-post-types/
Description: Allows the exporting of custom post types data to Magento
Version:     1.0.0.4
Author:      FishPig
...
class Fishpig_PostTypesAndTaxonimes
{
	/**
	 ...
	 *
	 */
	$fpPTT = new Fishpig_PostTypesAndTaxonimes();
	
	/**
	 * Register action
	 *
	 */
	add_action('init', array($fpPTT, 'run'), 9999);
